  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(instanceChksum, "s1bcd3YXmgddE80GszwGsvG") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(tpChksum, "s1bcd3YXmgddE80GszwGsvG") == 0) {
          extern mxArray *sf_c8_untitled_third_party_uses_info(void);
          plhs[0] = sf_c8_untitled_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(tpChksum, "s1bcd3YXmgddE80GszwGsvG") == 0) {
          extern mxArray *sf_c8_untitled_jit_fallback_info(void);
          plhs[0] = sf_c8_untitled_jit_fallback_info();
          break;
        }
      }
     ...
     case 8:
      {
        if (strcmp(tpChksum, "s1bcd3YXmgddE80GszwGsvG") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c8_untitled_get_post_codegen_info();
...

  {
    ...
    switch (chartFileNumber) {
     case 8:
      {
        if (strcmp(tpChksum, "s1bcd3YXmgddE80GszwGsvG") == 0) {
          extern mxArray *sf_c8_untitled_updateBuildInfo_args_info(void);
          plhs[0] = sf_c8_untitled_updateBuildInfo_args_info();
          break;
        }
      }
